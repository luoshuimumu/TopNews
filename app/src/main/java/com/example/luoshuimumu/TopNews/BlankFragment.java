...
//                = new GridLayoutManager(getActivity(), COUNT_PER_COLUMN);
    ...
    class MultiAdapter extends RecyclerView.Adapter<MultiViewHolder> {
        @Override
        ...
        public void onBindViewHolder(MultiViewHolder holder, int position) {
            String data = null == dataList ? null : dataList.get(position);
